...
export default function IndexRoute() {
  return (<>
    ...
    <div className="grid-main-center">
      ...
      <div>
        <p>Cards in Set have symbols with four different traits: shapes, colors, fill, and number.</p>
        <p>Find three cards where every trait is either all the same or all different:</p>
      </div>
